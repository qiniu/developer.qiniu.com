        ...
        scrollEvent = $(window).scroll(function() {
            ...
            switch (o.animation) {
                case 'fade':
                    ...
                    //$( ($(window).scrollTop() > scrollDis) ? $(".popover").fadeIn(o.animationInSpeed) : $(".popover").fadeOut(o.animationOutSpeed) );
                    break;
                case 'slide':
                    $( ($(window).scrollTop() > scrollDis) ? $self.slideDown(o.animationInSpeed) : $self.slideUp(o.animationOutSpeed) );
                    //$( ($(window).scrollTop() > scrollDis) ? $(".popover").slideDown(o.animationInSpeed) : $(".popover").slideUp(o.animationOutSpeed) );
                    break;
                default:
                    $( ($(window).scrollTop() > scrollDis) ? $self.show(0) : $self.hide(0) );
                    //$( ($(window).scrollTop() > scrollDis) ? $(".popover").show(0) : $(".popover").hide(0) );
            }
        });
