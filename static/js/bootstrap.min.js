...
! function(e) {
	...
	e.fn.collapse = function(n) {
		...
		n[e(i).hasClass("in") ? "addClass" : "removeClass"]("collapsed"), e(i).hasClass('in') ? n.children().first().removeAttr('class').addClass('icon-chevron-right') : n.children().first().removeAttr('class').addClass('icon-chevron-down'), e(i).collapse(s)
	})
}(window.jQuery), ! function(e) {
	"use strict";
