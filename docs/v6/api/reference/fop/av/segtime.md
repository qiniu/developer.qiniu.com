...
video_150k      | 码率为150K，长宽比沿用源视频设置，推荐在 3G 环境下使用
video_240k      | 码率为240K，长宽比沿用源视频设置，推荐在 3G 环境下使用
video_440k      | 码率为440K，长宽比沿用源视频设置，推荐在 WIFI 环境下使用
video_640k      | 码率为640K，长宽比沿用源视频设置，推荐在 WIFI 环境下使用
