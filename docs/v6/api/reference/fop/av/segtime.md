...
例子：[PlayList文件](http://7b1hac.com1.z0.glb.clouddn.com/Fr88-3sZu8HqPFot_BapyYtuz3k%3D%2FFgCBc3IlydY6CFIA8jhe7jIxCt1y) （复制链接，查看文件内容或直接用vlc播放器播放）
...
- `hlsKeyType` 指定了传送秘钥的方式
 ...
 - 公钥：[1.0](http://7b1hac.com1.z0.glb.clouddn.com/hls_rsa1.0.pub)
