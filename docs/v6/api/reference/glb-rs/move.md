...
```
POST /glb/move/<EncodedEntryURISrc>/<EncodedEntryURIDest> HTTP/1.1
Host:           rs.qiniu.com
...
curl -i \
     ...
     -X POST \
     'http://rs.qiniu.com/glb/move/bmV3ZG9jczpmaW5kX21hbi50eHQ=/bmV3ZG9jczpmaW5kLm1hbi50eHQ='
```
...
```
POST /glb/move/bmV3ZG9jczpmaW5kX21hbi50eHQ=/bmV3ZG9jczpmaW5kLm1hbi50eHQ= HTTP/1.1
