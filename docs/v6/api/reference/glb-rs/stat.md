...
```
GET /glb/stat/<EncodedEntryURI> HTTP/1.1
Host:          rs.qiniu.com
...
curl -i \
     ...
     "http://rs.qiniu.com/glb/stat/ZGVtbzoyMDEzLTAyLTA5LTA3LTM5LTIwLmpwZw=="
```
...
```
GET /glb/stat/ZGVtbzoyMDEzLTAyLTA5LTA3LTM5LTIwLmpwZw== HTTP/1.1
